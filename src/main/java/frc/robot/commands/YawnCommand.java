...
public class YawnCommand extends Command {
  private final FilterFeeder m_filterFeeder;
  /** Creates a new YawnCommand. */
  public YawnCommand(FilterFeeder filterFeeder) {
  ...
  public void initialize() {
    m_filterFeeder.moveIntakeAssemblyToGrabAlgae();
  }
